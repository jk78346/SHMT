...
for app_name in "mean_2d" "sobel_2d" "laplacian_2d" "fft_2d" "dct8x8_2d" "srad_2d" "hotspot_2d"
do
    ...
    do
        ...
        do
            for proposed_mode in "gpu" "t_p" "gt_s" "gt_b" "gt_c-saliency" "gt_c-ns-sdev" "gt_c-nr-sdev" "gt_c-ns-range" "gt_c-nr-range" 
            do
                for num in 5
                do
