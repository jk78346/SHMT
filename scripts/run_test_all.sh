...
for app_name in "mean_2d" "sobel_2d" "laplacian_2d" "fft_2d" "dct8x8_2d" "srad_2d" "hotspot_2d" "dwt_2d"
do
...
#sudo ./gpgtpu ${app_name} ${problem_size} ${problem_size} ${iter} ${baseline_mode} gpu
        ...
        do
            for proposed_mode in  "gt_c-oracle" #"t_p" "gt_s" "gt_b" "gt_c-ns-sdev" "gt_c-nr-sdev" "gt_c-ns-range" "gt_c-nr-range" 
            do
                for p in 128
                do
                    for num in 5
